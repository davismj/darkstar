...
function onTrigger(player, arg1, arg2, arg3, arg4, arg5)
    ...
    if (x == nil or y == nil or z == nil) then
        ...
        player:PrintToPlayer(string.format("%s's position: X %.4f  Y %.4f  Z %.4f  R %i (Zone %i)", targ:getName(), targ:getXPos(), targ:getYPos(), targ:getZPos(), targ:getRotPos(), targ:getZoneID() ));
    else
        if (zoneId == nil) then
