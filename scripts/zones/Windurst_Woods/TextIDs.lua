...
-- General Texts
   ITEM_CANNOT_BE_OBTAINED = 6538; -- Come back after sorting your inventory.
          ...
          KEYITEM_OBTAINED = 6546; -- Obtained key item: <keyitem>
              KEYITEM_LOST = 6547; -- Lost key item: <keyitem>
...
ITEM_DELIVERY_DIALOG =  6823; -- We can deliver goods to your residence or to the residences of your friends.
    NOKKHI_BAD_COUNT =  9749; -- What kinda smart-alecky baloney is this!? I told you to bring me the same kinda ammunition in complete sets. And don't forget the flowers, neither.
   NOKKHI_GOOD_TRADE =  9751; -- And here you go! Come back soon, and bring your friends!
     NOKKHI_BAD_ITEM =  9752; -- I'm real sorry, but there's nothing I can do with those.
...
-- Shop Texts
         ...
         PEW_SAHBARAEF_DIALOG = ITEM_DELIVERY_DIALOG; -- We can deliver goods to your residence or to the residences of your friends.
       ...
       KUZAH_HPIROHPON_DIALOG = 7961; -- Sew...I mean...“So,” want to get your paws on the top-quality materials as used in the Weaverrrs' Guild?
        ...
        MONONCHAA_SHOP_DIALOG = 8504; -- Huh...? If you be wanting anything therrre, ≺mister|missy>, then hurry up and decide, then get the heck out of herrre!
...
-- Harvest Festival
     ...
     THANK_YOU_TREAT = 9729; -- Thank you... And now for your treat...
